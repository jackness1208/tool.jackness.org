if (!-[ 1 ]) {
    ...
    function paramFn() {
        ...
        this.getString = function() {
            if (this.bgcolor) this.string += "&bg=" + this.bgcolor;
            if (this.fgcolor) this.string += "&fg=" + this.fgcolor;
            if (this.gccolor) this.string += "&gc=" + this.gccolor;
            if (this.ptcolor) this.string += "&pt=" + this.ptcolor;
            if (this.inptcolor) this.string += "&inpt=" + this.inptcolor;
            return this.string;
        };
    }
    window.params = "";
    ...
    function createPic(type) {
        ...
        timer = setTimeout(function() {
            ...
            if (type) {
                ...
                var apiurl = $("#apiUrl").attr("title") || "http://m.liantu.com";
            ...
            if (!uripart || uri == apiobj.attr("title")) return;
